...
image_name = 'dens_img_128'
loss_name = 'dens_loss_128'
for d in distances:
    start = timer()
    '''system_maker(no_of_systems ,max_spheres, max_sphere_size, no_of_points, no_of_projections, image_res)'''
    
    # Generate training images
    sphere_img_train = system_maker(15000, 50, 2, 100, 2, (128, 128),d)
    ellips_img_train = system_maker2(15000, 50, 2, 100, 2, (128, 128),d, 'powerlaw')
    
    # Generate testing images with different parameters
    sphere_img_test = system_maker(3750, 50, 2, 100, 2, (128, 128),d)
    ellips_img_test = system_maker2(3750, 50, 2, 100, 2,(128, 128),d, 'powerlaw')
