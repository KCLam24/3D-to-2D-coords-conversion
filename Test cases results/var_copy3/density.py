...
image_name = 'dens_Limg'
loss_name = 'dens_Lloss'
for d in distances:
    start = timer()
    '''system_maker(no_of_systems ,max_spheres, max_sphere_size, no_of_points, no_of_projections, image_res)'''
    
    # Generate training images
    sphere_img_train = system_maker(15000, 30, 1, 100, 2, (64, 64),d)
    ellips_img_train = system_maker2(15000, 30, 1, 100, 2, (64, 64),d, True)
    
    # Generate testing images with different parameters
    sphere_img_test = system_maker(3750, 30, 1, 100, 2, (64, 64),d)
    ellips_img_test = system_maker2(3750, 30, 1, 100, 2,(64, 64),d, True)
