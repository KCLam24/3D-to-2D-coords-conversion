...
distances = [2, 5, 50, 100, 300, 500]
image_name = 'dens_bw_Adpowimg8'
loss_name = 'dens_bw_Adpowloss8'
for d in distances:
    start = timer()
    ...
    ellips_img_train = system_maker2(15000, 50, 2, 100, 2, (64, 64),d, 'powerlaw')
    
    # Generate testing images with different parameters
    sphere_img_test = system_maker(3750, 50, 2, 100, 2, (64, 64),d)
    ellips_img_test = system_maker2(3750, 50, 2, 100, 2,(64, 64),d, 'powerlaw')
