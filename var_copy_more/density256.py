...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(8 * 128 * 128, 2)
...
distances = [2, 50, 100, 300, 500,1000]
image_name = 'dens_img_256'
loss_name = 'dens_loss_256'
for d in distances:
    start = timer()
    '''system_maker(no_of_systems ,max_spheres, max_sphere_size, no_of_points, no_of_projections, image_res)'''
    
    # Generate training images
    sphere_img_train = system_maker(8000, 30, 2, 100, 2, (256, 256),d)
    ellips_img_train = system_maker2(8000, 30, 2, 100, 2, (256, 256),d, 'powerlaw')
    
    # Generate testing images with different parameters
    sphere_img_test = system_maker(2000,30, 2, 100, 2, (256, 256),d)
    ellips_img_test = system_maker2(2000, 30, 2, 100, 2,(256, 256),d, 'powerlaw')
    ...
    plot_images(images_train[4],images_train[5000],images_train[30000],images_train[30011],f'{image_name}_dens{d}')
