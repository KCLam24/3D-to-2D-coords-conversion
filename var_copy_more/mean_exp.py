...
for i in range(len(mean_a)):
    for j in range(len(mean_b)):
        ...
        sphere_img_train = system_maker(16000, 30, 1, 100, 2, (64, 64),d)
        ellips_img_train = system_maker2(16000, 30, 1, 100, 2, (64, 64),d, 'exponential')
        
        # Generate testing images with different parameters
        sphere_img_test = system_maker(4000, 30, 1, 100, 2, (64, 64),d)
        ellips_img_test = system_maker2(4000, 30, 1, 100, 2,(64, 64),d, 'exponential')
