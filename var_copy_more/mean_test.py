...
d = 40
image_name = 'mean_pow_img'
loss_name = 'mean_pow_loss'
for i in range(len(mean_a)):
    for j in range(len(mean_b)):
        ...
        ellips_img_train = system_maker2(12500, 30, 1, 100, 2, (64, 64),d, 'powerlaw')
        
        # Generate testing images with different parameters
        sphere_img_test = system_maker(2500, 30, 1, 100, 2, (64, 64),d)
        ellips_img_test = system_maker2(2500, 30, 1, 100, 2,(64, 64),d, 'powerlaw')
