...
cov = [[variance_a, cov_ab], 
       [cov_ab, variance_b]]
d = 40
image_name = 'varLog_img'
loss_name = 'varLog_loss'
...
for i in range(len(variance_a)):
    for j in range(len(variance_b)):
        ...
        ellips_img_train = system_maker2(12500, 30, 1, 100, 2, (64, 64),d, True)
        
        # Generate testing images with different parameters
        sphere_img_test = system_maker(2500, 30, 1, 100, 2, (64, 64),d)
        ellips_img_test = system_maker2(2500, 30, 1, 100, 2,(64, 64),d, True)
        ...
        plot_images(images_train[4],images_train[1000],images_train[30000],images_train[40000],f'{image_name}_a{variance_a[i]}_b{variance_a[j]}')
        ...
        plot_loss_curves(model_results, f'{loss_name}_a{variance_a[i]}_b{variance_a[j]}')
