...
mean_a = mean_b = [0.1, 0.5, 1, 2, 5]
cov = [[variance_a, cov_ab], 
       [cov_ab, variance_b]]

d = 40
image_name = 'mean_exp_img'
loss_name = 'mean_exp_loss'
for i in range(len(mean_a)):
    for j in range(len(mean_b)):
        ...
        plot_images(images_train[4],images_train[1000],images_train[30000],images_train[40000],f'{image_name}_{mean}')
        ...
        plot_loss_curves(model_results, f'{loss_name}_{mean}')
