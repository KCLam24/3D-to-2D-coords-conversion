...
for i in range(len(a)):
    for j in range(len(b)):
        mean = [a[i], b[j]]  # Mean for a/c and b/c ratios
        ...
        plot_images(images_cont[40],images_cont[15930],images_cont[31068],images_cont[32091],f'image2_a{i}_b{j}')
       ...
       # print(f'System generation finished in {creation_time // 60:.0f} minutes {creation_time % 60:.0f} seconds {creation_time % 1 * 1000:.0f} milliseconds')
        ...
        plot_loss_curves(model_results, f'Loss2_a{i}_b{j}')
